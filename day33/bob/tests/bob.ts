...
describe("CPI from Alice to Bob", () => {
  ...
  const bobProgram = anchor.workspace.Bob as Program;
  const aliceProgram = anchor.workspace.Alice as Program;
  ...
  console.log(bobProgram.programId.toString());
  console.log(aliceProgram.programId.toString());
});
